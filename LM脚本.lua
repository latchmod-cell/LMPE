...
print("弹出(LMPE脚本-你的注入器是)"..identifyexecutor())
...
print("弹出(LMPE脚本-你的用户名是)"..game.Players.LocalPlayer.Character.Name)

local Window = OrionLib:MakeWindow({Name = "LMPE脚本", HidePremium = false, SaveConfig = true,IntroText = "欢迎使用LMPE脚本", ConfigFolder = "123"})

print("脚本加载成功✅")
print("创建主UI(LMPE脚本-LMPE脚本-123)")
